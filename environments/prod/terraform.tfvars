...
eks_private_subnets         = ["172.16.3.0/24", "172.16.4.0/24", "172.16.5.0/24", "172.16.6.0/24"]
...
eks_max_size                = 4
eks_min_size                = 2
eks_role_arn                = "arn:aws:iam::503561434440:role/eks-cluster-role"
eks_node_role_arn           = "arn:aws:iam::503561434440:role/eks-node-role"
...
vpc_config = {
  "EKS-vpc" = {
    ...
    private_subnets    = ["172.16.3.0/24", "172.16.4.0/24", "172.16.5.0/24", "172.16.6.0/24"]
    availability_zones = ["ap-northeast-2a", "ap-northeast-2c", "ap-northeast-2a", "ap-northeast-2c"]  # 가용 영역 3개로 맞춤 
  },
  "DB-vpc" = {
